    ...
    <Layout>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="text-2xl leading-normal lg:text-3xl lg:leading-normal xl:text-4xl xl:leading-normal md:w-7/12 lg:w-1/2 flex-shrink-0 md:order-3">
          <p className="mb-8 lg:mb-16">Since 2017, I've been lucky to work with clients such as <Link to="/projects/sydney-theatre-company">Sydney Theatre Company</Link>, <Link to="/projects/nla">the National Library of Australia</Link> and <Link to="/projects/rise"> Refugees, Inmates, Survivors and Ex-detainees (RISE)</Link>.</p>
