  ...
  return (
    <Layout>
      <section className="text-2xl leading-normal lg:text-3xl lg:leading-normal xl:text-4xl xl:leading-normal md:w-7/12 lg:w-1/2 md:float-right mb-8 md:mb-12 xl:mb-16">
        <p>Dialogic Studios is the personal graphic design practice of Hon Boey. I work on Gadigal land in Sydney, Australia.</p>
      </section>
      ...
      <section className="flex mb-12 md:mb-10 xl:mb-12">
        ...
        <div className="w-2/3 md:w-1/2">
          <p className="mb-4 lg:mb-8">I'm currently not taking any commercial projects but if you'd like to collaborate on a personal work then I’d love to hear from you.</p>
